...
const SingleVotePage = () => {
  ...
  return (
    <div className=" max-w-3xl mx-auto bg-white rounded-md text-text-color">
      <ConfirmDialog />
      <div className="p-4 w-full h-full bg-white rounded-md">
        ...
        <div className="space-y-3">
          ...
          <div className="rounded-md space-y-3 grid grid-cols-2 gap-4 ">
          ...
          <div className="mt-6 w-full">
            <Button
              className="w-full text-primary-col hover:text-primary-col/80"
              variant={"ghost"}
