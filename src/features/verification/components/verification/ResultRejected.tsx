...
const COMMITTEE_CONTACT_URL =
  process.env.NEXT_PUBLIC_COMMITTEE_CONTACT_URL ??
  "mailto:elections@college.edu";
  ...
  return (
    <div className="flex flex-col items-center gap-4 text-center">
      ...
      <p className="max-w-sm text-sm text-slate-600">
        The photo didn't match closely enough with your student record. Make
        sure your face is well-lit and centered, then try again.
      </p>
